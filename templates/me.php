        ...
        <div id="me-main">
            ...
            <div class="me-center">
                <div class="me-left-container">
                    ...
                    <div class="me-left-container-currency"><?="<div class='icon-credits'><b>",user::userCurrency("-1"),"</b></div> ","<div class='icon-pixels'><b>",user::userCurrency("0"),"</b></div><div class='icon-diamonds'><b>",user::userCurrency("5"),"</b></div><div class='icon-belcr'><b>",user::userCurrency("101"),"</b></div>"?></div>
                    ...
                    <div class="me-left-container-last-online">Laaste online: <?php if (user::userInfo("last_online") < 1){echo "N/a";}else{echo date("d/m/Y H:i",user::userInfo("last_online"));}?></div>
